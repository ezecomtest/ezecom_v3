	...
	<article>
		...
		<a href="https://www.ezecom.com.kh/index.php/en/media-center/news-and-events/734-ezecom-supported-cambodia-ict-awards-2017-launching-ceremony-in-calling-for-the-best-ict-acheivement-this-year" itemprop="url">		       
				...
				<header class="article-header clearfix">
					<a href="<?php echo base_url(); ?>newsdetail/<?php echo strtolower(str_replace(' ', '-', $firsttitle_events['content_title']));?>">
					<h5 class="article-title" itemprop="name"><?php echo $firsttitle_events['content_title']?></h5></a>
					    ...
					    <section class="article-intro clearfix">
							...
							if (strlen($string) > 350) {
							    ...
							    $string = substr($stringCut, 0, strrpos($stringCut, ' ')).'... <br/><a href="'.base_url().'newsdetail/'.ucwords(strtolower(str_replace(' ', '-', $firsttitle_events['content_title']))).'>Read More</a>'; 
							}
							echo $string;
							?></p>
		...
		<!-- Intro image -->
			<div class="row">
		      		...
		      		<div class="col-md-2" id="firstrecord" style="min-width:19.66%">
						<div class="pull-left item-image"><a href="<?php echo base_url(); ?>newsdetail/<?php echo strtolower(str_replace(' ', '-' ,$title->content_title));?>"> 
